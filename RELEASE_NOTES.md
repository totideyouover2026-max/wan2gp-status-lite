...
- Selectable stages, live timings and ETA, model/component identities, LTX post-processing detail, multi-pass/subwindow step observations, RAM/VRAM telemetry, download progress, and recovery after the window has been minimized.
...
- Per-step memory observations do not cause periodic samples to be counted twice.
